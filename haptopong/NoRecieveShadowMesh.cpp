...
NoRecieveShadowMesh::NoRecieveShadowMesh() {
    cGenericObject::setUseTransparency(true);
    //cGenericObject::setTransparencyLevel();
}

void NoRecieveShadowMesh::render(cRenderOptions& a_options)
{
    ...
    if (!newOptions.m_render_transparent_back_faces_only)
        cMultiMesh::render(newOptions);
}

void NoRecieveShadowMesh::renderSceneGraph(cRenderOptions& a_options)
{
#ifdef C_USE_OPENGL
