...
ShadowlessCylinder::ShadowlessCylinder(const double a_baseRadius, const double a_topRadius,const double a_height,  cMaterialPtr a_material) :
	cShapeCylinder(a_baseRadius, a_topRadius, a_height, a_material)
{
}

void ShadowlessCylinder::render(cRenderOptions& a_options)
{
	...
	cShapeCylinder::render(newOptions);
}

void ShadowlessCylinder::renderSceneGraph(cRenderOptions& a_options)
{
#ifdef C_USE_OPENGL
